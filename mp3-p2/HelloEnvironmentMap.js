...
{ 
    ...
    if(obtainedTeapot==1 && obtainedTextures==6)
    {
        ...
        **/
        ...
        gl.uniform1i(gl.getUniformLocation(shaderProgram, "mapEnvironment"), 0);        // Set boolean to shade teapot
        gl.uniform1i(gl.getUniformLocation(shaderProgram, "reflectiveTeapot"), document.getElementById("reflective").checked);  // Set boolean for teapot reflection
